...
from api.routes.forge_ohlcv import router as forge_ohlcv_router  # FORGE — survives updates
...
app.include_router(forge_ohlcv_router)  # FORGE OHLCV /historical — see apply-forge-mods.sh
